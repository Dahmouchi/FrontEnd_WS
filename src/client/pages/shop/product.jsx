...
export const Product = ({ id, name, price, onAddToCart, pic ,desc,qnt}) => {
    ...
    return (
        <div key={id} className="product">
            ...
            <div  class="wrapper">
                <div class="container">
                    <div class="top"> <img src={pic} alt="product" /></div>
                    <div class="bottom">
                    <div className="left">
                        <div class="details">
                            <h1>{name}</h1>
                        ...
                        <div class="buy" onClick={() => onAddToCart({ id })} ><i class="material-icons"><FontAwesomeIcon icon={faCartPlus} style={{width:"50px",height:"50px"}}/></i></div>
                    </div>
                    
                    </div>
                </div>
                <div class="inside">
                    <div class="icon"><FontAwesomeIcon icon={faCircleInfo} style={{width:"25px",height:"25px"}} /></div>
                    <div class="contents">
                    <table>
                    <tr>
                        <th>Title</th>
